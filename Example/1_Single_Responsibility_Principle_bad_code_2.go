...
func DriveVehicleWithoutInterface(vehicleType string) {
	switch vehicleType {
	case "Car":
...
func RefuelVehicleWithoutInterface(vehicleType string) {
	switch vehicleType {
	case "Car":
...
./1_Single_Responsibility_Principle_bad_code_2.go:41:2: car declared but not used
./1_Single_Responsibility_Principle_bad_code_2.go:42:2: plane declared but not used
*/
